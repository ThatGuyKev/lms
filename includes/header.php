  <div class="navbar navbar-inverse set-radius-zero" >
        <div class="container">
            ...
            <div class="right-div">
                <a href="routers/logout.php" class="btn btn-danger pull-right">LOG ME OUT</a>
            </div>
        </div>
    </div>
    <!-- LOGO HEADER END-->
 ...
 <li>
                           ...
                           <li>
                            ...
                            <li>
                                 ...
                                 <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
                                     <li role="presentation"><a role="menuitem" tabindex="-1" href="add-student.php">Add new Student</a></li>
